...
namespace Microsoft.Azure.WebJobs.Script.Grpc.Messages {
  ...
  public static partial class FunctionRpc
  {
    ...
    static readonly grpc::Marshaller<global::Microsoft.Azure.WebJobs.Script.Grpc.Messages.StreamingMessage> __Marshaller_AzureFunctionsRpcMessages_StreamingMessage = grpc::Marshallers.Create((arg) => global::Google.Protobuf.MessageExtensions.ToByteArray(arg), global::Microsoft.Azure.WebJobs.Script.Grpc.Messages.StreamingMessage.Parser.ParseFrom);
    ...
    [grpc::BindServiceMethod(typeof(FunctionRpc), "BindService")]
    ...
    public partial class FunctionRpcClient : grpc::ClientBase<FunctionRpcClient>
    {
      ...
      public FunctionRpcClient(grpc::ChannelBase channel) : base(channel)
      {
      }
    ...
    {
      serviceBinder.AddMethod(__Method_EventStream, serviceImpl == null ? null : new grpc::DuplexStreamingServerMethod<global::Microsoft.Azure.WebJobs.Script.Grpc.Messages.StreamingMessage, global::Microsoft.Azure.WebJobs.Script.Grpc.Messages.StreamingMessage>(serviceImpl.EventStream));
    }
